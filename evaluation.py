...
def get_evaluation(test_categories,
    ...
    for category in test_categories:
        ...
        for evaluation_level_index in range(len(evaluation_levels)):
            evaluation[category][evaluation_level_index] = {}
            ...
            evaluation[category][evaluation_level_index][recall_key] = recall_in_selection
...
def get_summarized_recalls(test_categories, evaluation, evaluation_levels, n_correct_ranked_docs_key, n_docs_in_category_key):
    ...
    for evaluation_level_index in range(len(evaluation_levels)):   
        total_n_of_correct_classified_documents =  sum([evaluation[category][evaluation_level_index][n_correct_ranked_docs_key] for category in test_categories])
